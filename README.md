...
I help developers ship fast so they can concentrate on production code, not infrastructure.
...
- 🔭 **IndiFlow (Private):** Architecting a SaaS-scale, graph-first project management platform.
  ...
  - **Status:** [MVP shipped to production.](https://indiflow.io) — invite only
